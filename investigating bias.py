...
#the test data here  has 100 positive and 0 negative sentences
...
#what is the distribution between the accuracy of positive and negative information is done by investigating bias
#stop shuffling the data first
#set testing data as positive first then see accuracy then do it with negative data and see the accuracy
